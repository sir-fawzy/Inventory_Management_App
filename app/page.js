    ...
    <>
      ...
      >
        ...
        <Box width="100vw" height="100vh" display="flex" justifyContent="center" alignItems="center" flexDirection="column" gap={2}>
          ...
          <Box bgcolor="grey" spacing={2} justifyContent="center" display="flex" flexDirection="column" borderRadius="15px" overflow="scroll"
          >
            <Button
              variant="contained"
              onClick={() => {
            ...
            <Box border="1px solid #333">
              ...
              >
                <Typography variant="h2" color="#333" fontFamily="Times New Roman">
                  Inventory Items
                </Typography>
              </Box>
            </Box>
